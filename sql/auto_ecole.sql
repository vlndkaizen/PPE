...
CREATE TABLE moniteur (
    ...
    nom VARCHAR(25),
    prenom VARCHAR(25),
    email VARCHAR(50) UNIQUE, -- AJOUT: Email pour connexion moniteur
    mdp VARCHAR(255) NOT NULL, 
    tel VARCHAR(25),
    adresse VARCHAR(50),
    experience INT(4),
...
CREATE TABLE cours (
    ...
    heure_debut TIME,
    heure_fin TIME,
    statut VARCHAR(20) DEFAULT 'À venir', -- AJOUT: Statut du cours
...
('Dupont', 'Jean', 'dupont@castellane.fr', 'Dupont', '0601020304', 10, 'B'),
('Martin', 'Sophie', 'martin@castellane.fr', 'Martin', '0605060708', 5, 'B+A');

INSERT INTO candidats (nom, prenom, email, mdp, tel, date_prevue_code) VALUES
('Dieng', 'Mouhammad', 'dieng@gmail.com', 'Dieng', '0601020304', '2026-03-15'),
('Leroy', 'Emma', 'emma@gmail.com', 'Leroy', '0612345678', '2026-04-01');


-- AJOUT: Cours avec statut
